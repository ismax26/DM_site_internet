<?php
	...
	*/
	...
	function connexion (){
		$connexion =mysqli_connect("localhost","root","","Dm_site_internet");
		if ($connexion == null){
	...
	function updatePatient ($tab){
		$requete="update patient set IDP='"
		.$tab['IDP']  . "' , nom='"
        .$tab['nom']  . "' , prenom='"
        .$tab['prenom']  . "' , adresse='"
	...
	function updateRDV ($tab){
		$requete="update rdv set IDPATIENT='"
		.$tab['IDPATIENT']  . "' , daterdv='"
        .$tab['daterdv']  . "' , heure='"
        .$tab['heure']  . "' , adresse='"
	...
	function updateMedecin ($tab){
		$requete="update medecin set idmedecin='"
		.$tab['idmedecin']  . "' , IDM='"
        .$tab['IDM']  . "' , adresse='"
        .$tab['adresse']  . "' , telephone='"
